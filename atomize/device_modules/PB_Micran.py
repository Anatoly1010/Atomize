    ...
    def pulser_update(self):
        ...
        if self.test_flag != 'test':
            ...
            if self.reset_count == 0 or self.shift_count == 1 or self.increment_count == 1 or self.rep_rate_count == 1:
                ...
                # Stop pulses
                self.device_write( 4, byte_to_write = 4, data_to_write = 56, type_of_systems = 2, shift = 1 )
                # rep rate in clock
                rep_time = rep_time // 4
                ...
                # Start pulses
                self.device_write( 4, byte_to_write = 4, data_to_write = 57, type_of_systems = 2, shift = 1 )
                self.pulser_close()
