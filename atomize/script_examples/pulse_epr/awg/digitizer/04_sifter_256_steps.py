...
# PULSES
REP_RATE = '2000 Hz'
PULSE_1_LENGTH = '150 ns'
PULSE_2_LENGTH = '150 ns'
PULSE_3_LENGTH = '150 ns'
PULSE_4_LENGTH = '150 ns'
PULSE_1_START = '0 ns'
...
awg.awg_pulse(name = 'P2', channel = 'CH0', func = 'WURST', frequency = ('80 MHz', '360 MHz'), phase = 0, \
...
awg.awg_pulse(name = 'P4', channel = 'CH0', func = 'WURST', frequency = ('80 MHz', '360 MHz'), phase = 0, \
...
awg.awg_pulse(name = 'P6', channel = 'CH0', func = 'WURST', frequency = ('80 MHz', '360 MHz'), phase = 0, \
...
pb.pulser_pulse(name = 'P7', channel = 'AWG', start = str( int(PULSE_4_START.split(' ')[0]) + 494 ) + ' ns', length = PULSE_4_LENGTH, \
                delta_start = str(STEP) + ' ns')
awg.awg_pulse(name = 'P8', channel = 'CH0', func = 'WURST', frequency = ('80 MHz', '360 MHz'), phase = 0, \
