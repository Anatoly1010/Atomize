...
PULSE_3_LENGTH = '44 ns'
PULSE_1_START = '0 ns'
PULSE_2_START = '86 ns'
PULSE_3_START = '236 ns'
PULSE_SIGNAL_START = '386 ns'
PHASE_CYCLE = 64

# NAMES
EXP_NAME = 'DPPH T1 Echo'
CURVE_NAME = 'exp1'
...
pb.pulser_pulse(name = 'P1', channel = 'MW', start = PULSE_2_START, length = PULSE_2_LENGTH, delta_start = str(int(STEP)) + ' ns', \
                phase_list = ['+x','+x','+x','+x','-x','-x','-x','-x','+y','+y','+y','+y','-y','-y','-y','-y', \
                              ...
                              '+x','+x','+x','+x','-x','-x','-x','-x','+y','+y','+y','+y','-y','-y','-y','-y', \
                              '+x','+x','+x','+x','-x','-x','-x','-x','+y','+y','+y','+y','-y','-y','-y','-y'])
pb.pulser_pulse(name = 'P2', channel = 'MW', start = PULSE_3_START, length = PULSE_3_LENGTH, delta_start = str(int(STEP)) + ' ns', \
