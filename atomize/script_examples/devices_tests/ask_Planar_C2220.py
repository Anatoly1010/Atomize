...
#C2220.vector_analyzer_center_frequency(CENTER, channel = 1)
##general.message( C2220.vector_analyzer_center_frequency(channel = 1) )

#C2220.vector_analyzer_frequency_range(SPAN, channel = 1)
#general.message( C2220.vector_analyzer_frequency_range(channel = 1) )

#C2220.vector_analyzer_points(POINTS, channel = 1)
#general.message( C2220.vector_analyzer_points(channel = 1) )

#C2220.vector_analyzer_intermediate_freqiency_bandwith('3000 Hz', channel = 1)
#general.message( C2220.vector_analyzer_intermediate_freqiency_bandwith(channel = 1) )
...
#general.message( C2220.vector_analyzer_get_frequency_points(channel = 1) )
#general.message( C2220.vector_analyzer_get_curve(s = 'S11', type = 'AP', channel = 1) )

# wait to measure
#general.wait('500 ms')
#xs = C2220.vector_analyzer_get_frequency_points(channel = 1)
#y1, y2 = C2220.vector_analyzer_get_curve(s = 'S11', type = 'AP', channel = 1)
