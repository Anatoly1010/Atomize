...
pb.pulser_pulse(name = 'P2', channel = 'MW', start = '364 ns', length = '16 ns', delta_start = '10 ns')
pb.pulser_pulse(name = 'P3', channel = 'TRIGGER', start = '572 ns', length = '100 ns', delta_start = '10 ns')
