...
awg.awg_pulse(name = 'P1', channel = 'CH0', func = 'GAUSS', frequency = '200 MHz', phase = 0, length = '64 ns', sigma = '16 ns', start = '300 ns', delta_start = '10 ns')
awg.awg_pulse(name = 'P2', channel = 'CH0', func = 'BLANK', frequency = '200 MHz', phase = 0, length = '20 ns', sigma = '16 ns', start = '500 ns', increment = '10 ns')
