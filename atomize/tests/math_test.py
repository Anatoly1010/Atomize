...
plotter.plot_xy('1D Plot', data[0], model_data[1], label='line', yname='Y axis', yscale='V', scatter='False')
plotter.plot_xy('1D Plot', data[0], residuals[1], label='scatter', yname='Y axis', yscale='V', scatter='True')
