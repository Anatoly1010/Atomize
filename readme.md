...
![Liveplot showing two live 1D plots with Show current run active](screenshots/screenshot2.png)

![Liveplot showing a live 2D echo map and its green-dot indicator](screenshots/screenshot3.png)
